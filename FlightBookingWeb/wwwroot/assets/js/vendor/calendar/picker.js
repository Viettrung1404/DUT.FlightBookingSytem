...
!function(a) {
    ...
    function b(g, h, j, l) {
        ...
        function r() {
            var b;
            !0 === x.hiddenName ? (b = g.name,
            g.name = "") : (b = ["string" == typeof x.hiddenPrefix ? x.hiddenPrefix : "", "string" == typeof x.hiddenSuffix ? x.hiddenSuffix : "_submit"],
            b = b[0] + g.name + b[1]),
        ...
        function u(a) {
            ...
            if (27 == b)
                return B.close(!0),
                !1;
            (32 == b || c || !w.open && B.component.key[b]) && (a.preventDefault(),
            a.stopPropagation(),
        ...
        var v = !1
          ...
          , B = A.prototype = {
            ...
            open: function(c) {
                ...
                !1 !== c && (w.open = !0,
                v && a("body").css("overflow", "hidden").css("padding-right", "+=" + d()),
                s(),
                k.on("click." + w.id + " focusin." + w.id, function(a) {
                    if (!w.handlingOpen) {
                        var b = e(a, g);
                    ...
                    var d = c.keyCode
                      , f = B.component.key[d]
                      , h = e(c, g);
                    27 == d ? B.close(!0) : h != B.$holder[0] || !f && 13 != d ? a.contains(B.$root[0], h) && 13 == d && (c.preventDefault(),
                    h.click()) : (c.preventDefault(),
                    f ? b._.trigger(B.component.key.go, B, [b._.trigger(f)]) : B.$root.find("." + y.highlighted).hasClass(y.disabled) || (B.set("select", B.component.item.highlight),
                    x.closeOnSelect && B.close(!0)))
                })),
                B.trigger("open"))
            },
            close: function(b) {
                return b && (x.editable ? g.focus() : (B.$holder.off("focus.toOpen").focus(),
                setTimeout(function() {
                ...
                w.open ? (w.open = !1,
                v && a("body").css("overflow", "").css("padding-right", "-=" + d()),
                k.off("." + w.id),
                B.trigger("close")) : B
            },
            clear: function(a) {
            ...
            set: function(b, c, d) {
                ...
                b) {
                    ...
                    for (e in h)
                        ...
                        "select" != e && "clear" != e || !x.updateInput || z.val("clear" == e ? "" : B.get(e, x.format)).trigger("change");
                    B.render()
                }
